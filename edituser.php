...
<form method="post"  action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
	...
	Полное имя:<br><input type="text" name="name" placeholder="<?php echo $oName; ?>">
	...
	Паспорт:<br><input type="text" name="ic" placeholder="<?php echo $oIC; ?>">
	...
	Телефон:<br><input type="text" name="contact" placeholder="<?php echo $oPhone; ?>">
